...
.WithOpenApi(info =>
{
    info.Description = "Endpoint utilizado para listar todos os cursos";
    info.Summary = "Listar os cursos";
    return info;
})
.WithTags("Cursos");
...
{
    return Results.Created("created", curso);
})
.WithOpenApi(info =>
{
    info.Description = "Endpoint utilizado para adicionar cursos";
    info.Summary = "Adicionar cursos";
    return info;
})
.WithTags("Cursos");
